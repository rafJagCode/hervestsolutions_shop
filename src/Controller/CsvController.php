...
class CsvController extends AbstractController
{
	...
	public function readCsv(): Response
	{
		...
		while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
			//name,description,quantity,price,sku,features
			...
			$sku = $column[4];
			$features = $column[5];
			$product = (object)['name' => $productName, 'description' => $description, 'quantity' => $quantity, 'price' => $price, 'sku' => $sku, 'features' => $features];
